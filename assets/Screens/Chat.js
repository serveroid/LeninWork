...
export const Chat = ({navigation, route})=>{
    ...
    useEffect(()=>{
        const unsubscribe = db.collection('chats').doc(route.params.chatId).collection('messages').orderBy('createdAt', 'desc').onSnapshot(snapshot=>
    ...
    const onSend = (messages)=>{
        ...
        db.collection('chats').doc(route.params.chatId).collection('messages').add({_id, createdAt, text, user});
